 ...
 */
package au.com.spotlight.test.setup;
...
import au.com.spotlight.test.constants.SpotlightTestConstants;
import au.com.spotlight.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SpotlightTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/spotlighttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/spotlighttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/spotlighttest/import/cstickets.impex");
			...
			importImpexFile(context, "/spotlighttest/import/csquotes.impex");
		}
	}
}
