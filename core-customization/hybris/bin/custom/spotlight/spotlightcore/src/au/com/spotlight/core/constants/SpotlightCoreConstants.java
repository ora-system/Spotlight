 ...
 */
package au.com.spotlight.core.constants;

/**
 * Global class for all SpotlightCore constants. You can add global constants for your extension into this class.
 */
public final class SpotlightCoreConstants extends GeneratedSpotlightCoreConstants
{
	public static final String EXTENSIONNAME = "spotlightcore";


	private SpotlightCoreConstants()
	{
		//empty
	}
