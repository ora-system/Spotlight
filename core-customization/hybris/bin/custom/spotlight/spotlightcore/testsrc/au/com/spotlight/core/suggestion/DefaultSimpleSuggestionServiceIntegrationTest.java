 ...
 */
package au.com.spotlight.core.suggestion;
...
import au.com.spotlight.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/spotlightcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
