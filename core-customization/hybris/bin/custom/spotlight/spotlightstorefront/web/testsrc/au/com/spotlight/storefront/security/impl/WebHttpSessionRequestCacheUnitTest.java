...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/spotlightstorefront/electronics/en",
						"https://electronics.local:9002/spotlightstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/spotlightstorefront/electronics/en",
						"https://electronics.local:9002/spotlightstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/spotlightstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/spotlightstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/spotlightstorefront/electronics/en",
						"https://electronics.local:9002/spotlightstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/spotlightstorefront",
						"https://electronics.local:9002/spotlightstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/spotlightstorefront",
						"https://electronics.local:9002/spotlightstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/spotlightstorefront/electronics/en",
						"https://electronics.local:9002/spotlightstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
