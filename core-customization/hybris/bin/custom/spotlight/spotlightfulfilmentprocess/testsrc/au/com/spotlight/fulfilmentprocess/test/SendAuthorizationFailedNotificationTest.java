...
import au.com.spotlight.fulfilmentprocess.actions.order.SendAuthorizationFailedNotificationAction;
...
public class SendAuthorizationFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link au.com.spotlight.fulfilmentprocess.actions.order.SendOrderPlacedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
