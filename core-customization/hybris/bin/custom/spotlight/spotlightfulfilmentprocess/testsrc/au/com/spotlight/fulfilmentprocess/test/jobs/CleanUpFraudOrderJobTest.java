 ...
 */
package au.com.spotlight.fulfilmentprocess.test.jobs;
...
import au.com.spotlight.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = SpotlightFulfilmentProcessConstants.ORDER_PROCESS_NAME;
