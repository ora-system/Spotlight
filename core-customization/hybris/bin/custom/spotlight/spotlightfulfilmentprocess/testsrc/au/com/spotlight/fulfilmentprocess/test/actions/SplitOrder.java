 ...
 */
package au.com.spotlight.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SpotlightFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SpotlightFulfilmentProcessConstants.PARENT_PROCESS);
